module github.com/StanzaSystems/sdk-go/adapters/fiberstanza/example
...
require (
	github.com/StanzaSystems/sdk-go/adapters/fiberstanza v0.0.0-20231218143256-5a6f226dc24f
...
require (
	buf.build/gen/go/grpc-ecosystem/grpc-gateway/protocolbuffers/go v1.32.0-20231027202514-3f42134f4c56.1 // indirect
	buf.build/gen/go/stanza/apis/grpc/go v1.3.0-20231026123415-1a9dca8fa2f6.2 // indirect
	buf.build/gen/go/stanza/apis/protocolbuffers/go v1.32.0-20231026123415-1a9dca8fa2f6.1 // indirect
	github.com/StanzaSystems/sdk-go v0.0.5-beta // indirect
...
replace github.com/StanzaSystems/sdk-go/adapters/fiberstanza => ../
