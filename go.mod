...
require (
	buf.build/gen/go/stanza/apis/grpc/go v1.3.0-20231026123415-1a9dca8fa2f6.2
	buf.build/gen/go/stanza/apis/protocolbuffers/go v1.32.0-20231026123415-1a9dca8fa2f6.1
